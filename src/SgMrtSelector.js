...
const genImage = ({displayStations},selectedStations,setSelectedStations,removeSelectedStation,title,config)=> {
  ...
  height="1007" width="1410"  preserveAspectRatio="xMidYMid meet">
    <title>Singapore MRT/LRT system map</title>
     <rect id="bg" height="1007" width="1410" y="0" x="0" fill={config["backgroundColor"]||"#ffffff"}/>
     <g id="title">
      <text id="tttitle" x="7.1" y="19" fontSize="20" fontWeight="bold" fill={config["title"]["textColor"]||"#ffffff"} fontFamily="Arial">{title||"Singapore MRT MAP"}</text>
...
const SGMrtSelector=({selectedStations,onStationsCheckChange,displayStations,isDisplayFutureStation,title,config})=> {
        ...
        return(<div><div style={{"width": `100vw`,
                    "overflow": `scroll`,
                    "margin": `0 auto`}}>
            {genImage(stns,selectedStn,addSelectedStation,removeSelectedStation,title,config||{'textColor':"#2bf96ae8",'title':{'textColor':"#fd4141f5"},'backgroundColor':'#171717e8'})}
